...
> ImagineVid가 엄선한 Muse Image 프롬프트, 재사용 가능한 프롬프트 스킬, 비주얼 예시 모음
...
**[Muse Image 프롬프트 컬렉션 보기](https://imaginevid.io/ko/ai-image-generator)**

이 컬렉션을 쓰는 이유

모든 사례는 원문 출처와 제작자 표시를 유지합니다. 제작 링크는 ImagineVid로, 기능 설명은 Meta의 1차 자료로 연결됩니다.
...
- [**에이전트 검색 및 사실 기반 비주얼**](#workflow-agentic-research-factual-visuals) - 최신 사실, 계산 또는 코드로 만든 구조를 이미지에 반영하는 리서치형 프롬프트입니다.
- [**정밀 편집 및 장면 보존**](#workflow-precision-editing-scene-preservation) - 구도, 조명, 정체성, 주변 세부를 유지하면서 목표만 바꾸는 국소 편집입니다.
- [**다중 참조 합성 및 정체성**](#workflow-multi-reference-composition-identity) - 여러 참조를 결합하면서 인물, 제품, 의상 또는 시각 체계의 일관성을 보존합니다.
- [**타이포그래피, 포스터 및 구조화 레이아웃**](#workflow-typography-posters-structured-layouts) - 읽기 쉬운 글자, 정보 위계, 간격, 반복 가능한 레이아웃 규칙이 중요한 디자인입니다.
- [**연속 아트 및 소셜 포맷**](#workflow-sequential-art-social-formats) - 프레임마다 일관성을 유지해야 하는 캐러셀, 패널, 이야기 시퀀스 및 소셜 형식입니다.
- [**인물, 질감 및 아트 디렉션**](#workflow-portraits-texture-art-direction) - 인물 유사성, 재질 질감, 조명과 의도적인 시각 언어를 중심으로 한 인물 및 아트 디렉션입니다.
...
- [큐레이션 보기](#큐레이션-보기)
- [Muse Image란?](#muse-image란)
- [공식 기능 사례](#official-capability-cases)
- [통계](#통계)
...
**Muse Image**는 Meta가 2026년 7월 공개한 에이전트형 이미지 생성 및 편집 모델입니다. 검색과 코드 도구를 사용하고, 추론 시 추가 계산으로 결과를 점검하고 개선하며, 여러 참조 이미지를 결합하고 장면의 나머지를 보존한 채 국소 편집을 수행할 수 있습니다. Meta AI와 일부 소비자 제품에 순차 적용 중이며 이용 범위는 제품과 지역에 따라 다릅니다.
...
- **모델이 결과를 스스로 검토하게 하기** - 에이전트 도구 사용과 자기 개선으로 사실성, 레이아웃, 세부 표현을 높입니다
- **대화형 개선** - 전체 브리프를 다시 쓰지 않고 구도, 피사체, 조명, 스타일을 계속 조정할 수 있습니다
- **전체 프레임을 다시 만들지 않고 편집** - 구도, 정체성, 조명, 영향받지 않는 요소를 유지한 채 대상만 바꿉니다
- **제품별 제공 범위를 확인** - Muse Image는 순차 출시 중이며 이 저장소는 공개 개발자 API를 전제로 하지 않습니다

**조사 출처:** [Meta AI engineering overview](https://ai.meta.com/blog/introducing-muse-image-muse-video-msl/) · [Meta product announcement](https://about.fb.com/news/2026/07/introducing-muse-image-meta-ai/) · [Create images on ImagineVid](https://imaginevid.io/ko/ai-image-generator)
...
> Meta의 1차 공개 사례입니다. 편집 제목은 번역하고 공식 프롬프트는 검증을 위해 영어 원문을 유지합니다.
...
#### 사례 1: Scannable conference QR code in a manhwa scene
...
#### 사례 2: Swiss poster with coded Julia and Sierpinski fractals
...
#### 사례 3: Search-grounded moon-formation infographic
...
#### 사례 4: Marketplace-grounded bedroom redesign
...
#### 사례 5: Historical photo restoration
...
#### 사례 6: Fog removal with valley reveal
...
#### 사례 7: Rainbow-gradient flower edit
...
#### 사례 8: Exact parking-sign text replacement
...
#### 사례 9: Context-preserving zoom-out
...
#### 사례 10: Cat-and-dog picnic becomes a complete cafe identity
...
| 총 프롬프트 | **8** |
| 추천 | **3** |
| 마지막 업데이트 | **2026년 7월 22일 수요일 오전 10시 21분 42초 UTC** |
...
최신 현지 가격을 조사해 읽기 쉬운 시장 표지판으로 표현하는 사실 기반 편집 이미지입니다.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMr-IOpXcAAnURh.jpg" width="100%" alt="실시간 시장 가격 보도 사진 - Image 1"></td>
</tr>
</table>
...
- **출처:** [출처](https://x.com/ozansihay/status/2074751589714133153)
- **게시일:** 2026년 7월 8일
- **언어:** tr
...
구도, 의상, 포즈, 가림, 조명, 필름 질감은 그대로 두고 대상 인물만 교체합니다.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PIGCXIAAbkrj.jpg" width="100%" alt="장면 흔들림 없는 캐릭터 교체 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PJw3XoAAgT0v.jpg" width="100%" alt="장면 흔들림 없는 캐릭터 교체 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PLCsWkAAL7Ls.jpg" width="100%" alt="장면 흔들림 없는 캐릭터 교체 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PM6-WUAE-8dS.jpg" width="100%" alt="장면 흔들림 없는 캐릭터 교체 - Image 4"></td>
</tr>
</table>
...
- **출처:** [출처](https://x.com/VictorInFocus/status/2075689215510122714)
- **게시일:** 2026년 7월 10일
- **언어:** en
...
하나의 연속 마스터를 완성한 뒤 네 장으로 나눠 원근, 조명, 정체성, 이음새를 유지합니다.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fyyWEAARe9g.jpg" width="100%" alt="네 장으로 이어지는 파노라마 캐러셀 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy2WIAAF6mr.jpg" width="100%" alt="네 장으로 이어지는 파노라마 캐러셀 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy3XYAA0zAk.jpg" width="100%" alt="네 장으로 이어지는 파노라마 캐러셀 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy1XcAAayV9.jpg" width="100%" alt="네 장으로 이어지는 파노라마 캐러셀 - Image 4"></td>
</tr>
</table>
...
- **출처:** [출처](https://x.com/IamEmily2050/status/2075734256316199185)
- **게시일:** 2026년 7월 11일
- **언어:** en
...
### 에이전트 검색 및 사실 기반 비주얼 (1)

최신 사실, 계산 또는 코드로 만든 구조를 이미지에 반영하는 리서치형 프롬프트입니다.

**Community · 추천 프롬프트**

- [실시간 시장 가격 보도 사진](#prompt-1)
...
소프트웨어 뷰포트를 물리적 경계로 만들고 후속 편집에서는 깨진 유리만 강화합니다.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqSskFbQAAaJVb.jpg" width="100%" alt="Unity Editor 밖으로 걸어 나오기 - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqSskBa0AAkNSL.jpg" width="100%" alt="Unity Editor 밖으로 걸어 나오기 - Image 2"></td>
</tr>
</table>

##### 세부 정보

- **작성자:** [Dilmer](https://x.com/Dilmerv)
- **출처:** [출처](https://x.com/Dilmerv/status/2074632200394523110)
- **게시일:** 2026년 7월 7일
- **언어:** en
...
독창적인 콘셉트, 세로 구성, 정확한 현지 제목 표현을 시험하는 간결한 프롬프트입니다.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMsJYvPWwAABNOy.jpg" width="100%" alt="튀르키예 독립 SF 영화 포스터 - Image 1"></td>
</tr>
</table>
...
- **작성자:** [Ozan Sihay](https://x.com/ozansihay)
- **출처:** [출처](https://x.com/ozansihay/status/2074762671342186760)
- **게시일:** 2026년 7월 8일
- **언어:** tr
...
2부터 47까지 각 소수에 고유 생물을 배정해 격자, 개수, 텍스트 정확도를 시험합니다.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqH0-qaYAAI3TM.jpg" width="100%" alt="소수 생물 도감 - Image 1"></td>
</tr>
</table>
...
- **출처:** [출처](https://x.com/minimaxir/status/2074619946026586223)
- **게시일:** 2026년 7월 7일
- **언어:** en
...
프레임마다 일관성을 유지해야 하는 캐러셀, 패널, 이야기 시퀀스 및 소셜 형식입니다.

**Community · 추천 프롬프트**

- [네 장으로 이어지는 파노라마 캐러셀](#prompt-3)
...
낡은 가죽, 청록색 회벽, 방향성 조명, 깊은 색보정으로 절제된 편집 초상을 만듭니다.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCVSZ6bQAAQJkR.jpg" width="100%" alt="고전 회화풍 윙백 체어 초상 - Image 1"></td>
</tr>
</table>
...
1. [**새 프롬프트 제출**](https://github.com/imagineVid/Awesome-muse-image-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**[Star 기록](https://star-history.com/#imagineVid/Awesome-muse-image-prompts-and-skills&Date)**

---

<div align="center">

**[큐레이션 보기](https://imaginevid.io/ko/ai-image-generator)** •
...
<sub>이 README는 자동 생성되었습니다. 마지막 업데이트: 2026-07-22T10:21:42.871Z</sub>
