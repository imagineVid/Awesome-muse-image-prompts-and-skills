...
> 有来源依据的 Muse Image 提示词案例，覆盖生成、编辑与多轮创意工作流。
# Muse Image 提示词与技能大全
...
> Muse Image 智能体生成、精准编辑与多参考合成的提示词和视觉案例合集
...
**[浏览 Muse Image 提示词合集](https://imaginevid.io/zh/ai-image-generator)**

为什么使用这个合集？

每条案例均保留原始来源与作者署名；产品操作入口指向 ImagineVid，能力说明依据 Meta 第一方资料。
...
- [**智能检索与事实视觉**](#workflow-agentic-research-factual-visuals) - 把实时事实、计算结果或代码生成结构转化为画面内容的检索型提示词。
- [**精准编辑与场景保留**](#workflow-precision-editing-scene-preservation) - 只修改目标区域，同时保护构图、光线、身份与未受影响场景细节。
- [**多参考合成与身份一致性**](#workflow-multi-reference-composition-identity) - 组合多个参考图，同时保持人物、产品、服装或视觉系统的可识别一致性。
- [**排版、海报与结构化布局**](#workflow-typography-posters-structured-layouts) - 强调文字可读性、信息层级、间距与可复用版式规则的设计视觉。
- [**连续画面与社交媒体格式**](#workflow-sequential-art-social-formats) - 需要跨画面保持连贯的轮播图、多格画面、故事序列与社交媒体格式。
- [**肖像、质感与艺术指导**](#workflow-portraits-texture-art-direction) - 以人物相似度、材质纹理、光线与明确视觉语言为核心的肖像和艺术指导提示词。
...
- [查看精选合集](#查看精选合集)
- [什么是 Muse Image？](#什么是-muse-image)
- [官方能力案例](#official-capability-cases)
- [统计数据](#统计数据)
...
**Muse Image** 是 Meta 于 2026 年 7 月发布的智能体式图像生成与编辑模型。它可以调用搜索和代码工具，在推理阶段投入更多计算来检查并改进结果，组合多个参考图，并在保留其余场景的同时完成局部编辑。Meta 已开始在 Meta AI 及部分消费产品中逐步开放，具体可用范围取决于产品与地区。
...
- **让模型检查自己的结果** - 智能体工具调用与自我改进可提升事实依据、版式和视觉细节
- **对话式细化** - 无需重写完整需求，即可继续调整构图、主体细节、光线与风格
- **无需重做整幅画面** - 只修改目标区域，同时保留构图、身份、光线和未受影响的物体
- **按具体产品判断可用性** - Muse Image 正在 Meta 各产品中逐步开放，本仓库不暗示存在公开开发者 API

**调研来源：** [Meta AI engineering overview](https://ai.meta.com/blog/introducing-muse-image-muse-video-msl/) · [Meta product announcement](https://about.fb.com/news/2026/07/introducing-muse-image-meta-ai/) · [Create images on ImagineVid](https://imaginevid.io/zh/ai-image-generator)
...
> Meta 第一方发布案例。编辑标题已本地化，官方来源提示词保留英文以便核验。
...
#### 案例 1: Scannable conference QR code in a manhwa scene
...
#### 案例 2: Swiss poster with coded Julia and Sierpinski fractals
...
#### 案例 3: Search-grounded moon-formation infographic
...
#### 案例 4: Marketplace-grounded bedroom redesign
...
#### 案例 5: Historical photo restoration
...
#### 案例 6: Fog removal with valley reveal
...
#### 案例 7: Rainbow-gradient flower edit
...
#### 案例 8: Exact parking-sign text replacement
...
#### 案例 9: Context-preserving zoom-out
...
#### 案例 10: Cat-and-dog picnic becomes a complete cafe identity
...
| 提示词总数 | **11** |
| 精选 | **3** |
| 最后更新 | **2026年7月31日星期五 UTC 13:52:52** |
...
让 Muse Image 检索当地现价，并把价格以清晰可读的市场标签呈现在纪实照片中。
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMr-IOpXcAAnURh.jpg" width="100%" alt="实时市场价格新闻摄影 - Image 1"></td>
</tr>
</table>
...
- **来源:** [来源](https://x.com/ozansihay/status/2074751589714133153)
- **发布时间:** 2026年7月8日
- **语言:** tr
...
只替换电影剧照中的目标人物，同时保留镜头、服装、姿态、遮挡、光线和影像质感。
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PIGCXIAAbkrj.jpg" width="100%" alt="无场景漂移的角色替换 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PJw3XoAAgT0v.jpg" width="100%" alt="无场景漂移的角色替换 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PLCsWkAAL7Ls.jpg" width="100%" alt="无场景漂移的角色替换 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PM6-WUAE-8dS.jpg" width="100%" alt="无场景漂移的角色替换 - Image 4"></td>
</tr>
</table>
...
- **来源:** [来源](https://x.com/VictorInFocus/status/2075689215510122714)
- **发布时间:** 2026年7月10日
- **语言:** en
...
先完成一张连续主画面，再切成四张竖图，确保透视、光线、角色与接缝完全一致。
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fyyWEAARe9g.jpg" width="100%" alt="四卡无缝全景轮播图 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy2WIAAF6mr.jpg" width="100%" alt="四卡无缝全景轮播图 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy3XYAA0zAk.jpg" width="100%" alt="四卡无缝全景轮播图 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy1XcAAayV9.jpg" width="100%" alt="四卡无缝全景轮播图 - Image 4"></td>
</tr>
</table>
...
- **来源:** [来源](https://x.com/IamEmily2050/status/2075734256316199185)
- **发布时间:** 2026年7月11日
- **语言:** en
...
把实时事实、计算结果或代码生成结构转化为画面内容的检索型提示词。
...
把软件视口变成真实边界的趣味参考编辑，并通过第二轮只强化玻璃破碎效果。
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqSskFbQAAaJVb.jpg" width="100%" alt="从 Unity 编辑器中走出来 - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqSskBa0AAkNSL.jpg" width="100%" alt="从 Unity 编辑器中走出来 - Image 2"></td>
</tr>
</table>
...
- **来源:** [来源](https://x.com/Dilmerv/status/2074632200394523110)
- **发布时间:** 2026年7月7日
- **语言:** en
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMsJYvPWwAABNOy.jpg" width="100%" alt="土耳其独立科幻电影海报 - Image 1"></td>
</tr>
</table>
...
- **作者:** [Ozan Sihay](https://x.com/ozansihay)
- **来源:** [来源](https://x.com/ozansihay/status/2074762671342186760)
- **发布时间:** 2026年7月8日
- **语言:** tr
...
将 2 到 47 的每个质数映射成独特收藏生物，测试严格网格、计数与文字准确性。
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqH0-qaYAAI3TM.jpg" width="100%" alt="质数生物图鉴 - Image 1"></td>
</tr>
</table>
...
- **来源:** [来源](https://x.com/minimaxir/status/2074619946026586223)
- **发布时间:** 2026年7月7日
- **语言:** en
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNJ9nGUXAAACn8y.jpg" width="100%" alt="新增案例：For Meta Muse image, remember it is still free - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNJ9nGbXYAA-ZQa.jpg" width="100%" alt="新增案例：For Meta Muse image, remember it is still free - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNJ9nGSWUAAxnE9.jpg" width="100%" alt="新增案例：For Meta Muse image, remember it is still free - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNJ9nGPXMAAiNze.jpg" width="100%" alt="新增案例：For Meta Muse image, remember it is still free - Image 4"></td>
</tr>
</table>
...
- **作者:** [Emily](https://x.com/IamEmily2050)
- **来源:** [来源](https://x.com/IamEmily2050/status/2076860545756545044)
- **发布时间:** 2026年7月14日
- **语言:** en
...
- **来源:** [来源](https://x.com/hatman/status/2075082522069782732)
- **发布时间:** 2026年7月9日
- **语言:** en
...
需要跨画面保持连贯的轮播图、多格画面、故事序列与社交媒体格式。
...
以旧皮革、斑驳蓝绿色墙面、侧向光和厚重电影调色构成克制的编辑肖像。
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCVSZ6bQAAQJkR.jpg" width="100%" alt="古典大师风扶手椅肖像 - Image 1"></td>
</tr>
</table>
...
1. [**提交新提示词**](https://github.com/imagineVid/Awesome-muse-image-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. 填写提示词详情和图片信息
3. 提交后等待维护者审核
4. 审核通过后可同步到本地仓库数据
...
**[Star 历史](https://star-history.com/#imagineVid/Awesome-muse-image-prompts-and-skills&Date)**

---

<div align="center">

**[查看精选合集](https://imaginevid.io/zh/ai-image-generator)** •
...
<sub>本 README 自动生成。最后更新： 2026-07-31T13:52:52.849Z</sub>
