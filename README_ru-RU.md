...
# Awesome Muse Image: промпты и навыки
...
> Подборка промптов Muse Image, переиспользуемых навыков промптинга и визуальных примеров от ImagineVid
...
**[Смотреть коллекцию промптов ImagineVid для Muse Image](https://imaginevid.io/ru/ai-image-generator)**

Зачем использовать эту коллекцию?

Каждый пример сохраняет первоисточник и указание автора. Ссылки для создания ведут на ImagineVid, а описание возможностей опирается на первичные материалы Meta.
...
- [**Агентный поиск и фактологические визуалы**](#workflow-agentic-research-factual-visuals) - Исследовательские промпты, в которых актуальные факты, расчёты или кодовая структура становятся частью изображения.
- [**Точное редактирование и сохранение сцены**](#workflow-precision-editing-scene-preservation) - Локальные правки цели с сохранением композиции, света, идентичности и остальных деталей сцены.
- [**Композиция по нескольким референсам и идентичность**](#workflow-multi-reference-composition-identity) - Композиции по нескольким референсам с сохранением узнаваемости людей, продуктов, одежды и визуальных систем.
- [**Типографика, постеры и структурированные макеты**](#workflow-typography-posters-structured-layouts) - Дизайнерские изображения, где важны читаемый текст, иерархия, интервалы и повторяемые правила макета.
- [**Последовательное искусство и соцформаты**](#workflow-sequential-art-social-formats) - Карусели, панели, сюжетные последовательности и социальные форматы с межкадровой согласованностью.
- [**Портреты, фактура и арт-дирекшн**](#workflow-portraits-texture-art-direction) - Портретные и арт-директорские промпты с акцентом на сходство, фактуру, свет и осознанный визуальный язык.
...
- [Что такое Muse Image?](#что-такое-muse-image)
- [Официальные примеры возможностей](#official-capability-cases)
...
- **Позвольте модели проверить свою работу** - Агентные инструменты и самоулучшение повышают фактическую точность, качество макета и деталей
- **Диалоговое уточнение** - Меняйте композицию, объект, свет и стиль без полного переписывания задания
- **Редактируйте без пересборки кадра** - Меняйте только цель, сохраняя композицию, идентичность, свет и остальные объекты
- **Проверяйте доступность для конкретного продукта** - Muse Image развёртывается поэтапно; репозиторий не предполагает наличия публичного API

**Источники исследования:** [Meta AI engineering overview](https://ai.meta.com/blog/introducing-muse-image-muse-video-msl/) · [Meta product announcement](https://about.fb.com/news/2026/07/introducing-muse-image-meta-ai/) · [Create images on ImagineVid](https://imaginevid.io/ru/ai-image-generator)
...
## Официальные примеры возможностей

> Первичные примеры запуска от Meta. Редакционные заголовки локализованы, официальные промпты сохранены на английском для проверки.
...
#### Пример 1: Scannable conference QR code in a manhwa scene
...
#### Пример 2: Swiss poster with coded Julia and Sierpinski fractals
...
#### Пример 3: Search-grounded moon-formation infographic
...
#### Пример 4: Marketplace-grounded bedroom redesign
...
#### Пример 5: Historical photo restoration
...
#### Пример 6: Fog removal with valley reveal
...
#### Пример 7: Rainbow-gradient flower edit
...
#### Пример 8: Exact parking-sign text replacement
...
#### Пример 9: Context-preserving zoom-out
...
#### Пример 10: Cat-and-dog picnic becomes a complete cafe identity
...
| Всего промптов | **13** |
| Избранное | **3** |
| Обновлено | **воскресенье, 13 сентября 2026 г. в 02:47:33 UTC** |
...
### No. 1: Новостная фотография с актуальными рыночными ценами
...
Фактологический кадр, который исследует местные цены и выводит их на читаемых ценниках.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMr-IOpXcAAnURh.jpg" width="100%" alt="Новостная фотография с актуальными рыночными ценами - Image 1"></td>
</tr>
</table>
...
- **Источник:** [Источник](https://x.com/ozansihay/status/2074751589714133153)
...
### No. 2: Перенос персонажа без дрейфа сцены
...
Меняет только нужного героя, сохраняя кадр, одежду, позу, перекрытия, свет и фототекстуру.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PIGCXIAAbkrj.jpg" width="100%" alt="Перенос персонажа без дрейфа сцены - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PJw3XoAAgT0v.jpg" width="100%" alt="Перенос персонажа без дрейфа сцены - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PLCsWkAAL7Ls.jpg" width="100%" alt="Перенос персонажа без дрейфа сцены - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM5PM6-WUAE-8dS.jpg" width="100%" alt="Перенос персонажа без дрейфа сцены - Image 4"></td>
</tr>
</table>

#### Детали

- **Автор:** [V](https://x.com/VictorInFocus)
- **Источник:** [Источник](https://x.com/VictorInFocus/status/2075689215510122714)
...
### No. 3: Бесшовная панорама из четырех карточек
...
Сначала создаёт единый мастер, затем режет его на четыре части без разрыва перспективы и света.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fyyWEAARe9g.jpg" width="100%" alt="Бесшовная панорама из четырех карточек - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy2WIAAF6mr.jpg" width="100%" alt="Бесшовная панорама из четырех карточек - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy3XYAA0zAk.jpg" width="100%" alt="Бесшовная панорама из четырех карточек - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM58fy1XcAAayV9.jpg" width="100%" alt="Бесшовная панорама из четырех карточек - Image 4"></td>
</tr>
</table>
...
- **Источник:** [Источник](https://x.com/IamEmily2050/status/2075734256316199185)
...
### Агентный поиск и фактологические визуалы (1)

Исследовательские промпты, в которых актуальные факты, расчёты или кодовая структура становятся частью изображения.

**Community · Избранные промпты**

- [Новостная фотография с актуальными рыночными ценами](#prompt-1)
...
Превращает окно программы в физическую границу и во втором проходе усиливает только разбитое стекло.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqSskFbQAAaJVb.jpg" width="100%" alt="Шаг из редактора Unity - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqSskBa0AAkNSL.jpg" width="100%" alt="Шаг из редактора Unity - Image 2"></td>
</tr>
</table>

##### Детали

- **Автор:** [Dilmer](https://x.com/Dilmerv)
- **Источник:** [Источник](https://x.com/Dilmerv/status/2074632200394523110)
...
Короткий тест идеи, вертикальной композиции и читаемого локализованного заголовка.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMsJYvPWwAABNOy.jpg" width="100%" alt="Турецкий независимый научно-фантастический постер - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Ozan Sihay](https://x.com/ozansihay)
- **Источник:** [Источник](https://x.com/ozansihay/status/2074762671342186760)
- **Опубликовано:** 8 июля 2026 г.
- **Языки:** tr
...
Сопоставляет каждому простому числу от 2 до 47 уникальное существо, проверяя сетку, счёт и текст.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMqH0-qaYAAI3TM.jpg" width="100%" alt="Каталог существ по простым числам - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [Max Woolf](https://x.com/minimaxir)
- **Источник:** [Источник](https://x.com/minimaxir/status/2074619946026586223)
- **Опубликовано:** 7 июля 2026 г.
- **Языки:** en
...
Карусели, панели, сюжетные последовательности и социальные форматы с межкадровой согласованностью.

**Community · Избранные промпты**

- [Бесшовная панорама из четырех карточек](#prompt-3)
...
Сдержанный портрет с потертой кожей, сине-зелёной штукатуркой, боковым светом и плотным грейдом.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCVSZ6bQAAQJkR.jpg" width="100%" alt="Портрет в кресле в духе старых мастеров - Image 1"></td>
</tr>
</table>
...
1. [**Отправить новый промпт**](https://github.com/imagineVid/Awesome-muse-image-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**[История звезд](https://star-history.com/#imagineVid/Awesome-muse-image-prompts-and-skills&Date)**

---

<div align="center">

**[Открыть подборку](https://imaginevid.io/ru/ai-image-generator)** •
...
<sub>Этот README создан автоматически. Последнее обновление: 2026-09-13T02:47:33.445Z</sub>
